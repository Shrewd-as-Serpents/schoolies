...
SAGE Publications' *Qualitative Research Methods Series* (the "Little Blue Books") has codified this apparatus for decades. Manuals like David L. Altheide's *Qualitative Media Analysis* (2011) champion qualitative inquiry as reflexive and circular, and instruct students on "reflexive research designs" — but this reflexivity is procedural, not structural: it never interrogates how the core methodological concepts themselves (coding, validity, triangulation) are historically situated, Eurocentric technologies of control.
